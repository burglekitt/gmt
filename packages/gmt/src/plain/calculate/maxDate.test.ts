...
describe("maxDate", () => {
  it.each`
    dates                                         | expected
    ${["2024-03-10", "2024-01-01", "2024-02-15"]} | ${"2024-03-10"}
    ${["2023-12-31", "2024-01-01"]}               | ${"2024-01-01"}
    ${["2024-06-15", "2024-03-20", "2024-09-01"]} | ${"2024-09-01"}
  `("returns $expected for dates $dates", ({ dates, expected }) => {
    expect(maxDate(dates)).toBe(expected);
  });
