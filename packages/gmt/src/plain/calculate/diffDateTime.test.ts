...
describe("diffDateTime", () => {
  it.each`
    ...
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T01:00:00"}           | ${"hour"}        | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T12:00:00"}           | ${"hour"}        | ${12}
    ${"2024-03-17T12:30:45"} | ${"2024-03-17T13:30:45"}           | ${"hour"}        | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:01:00"}           | ${"minute"}      | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:30:00"}           | ${"minute"}      | ${30}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:00:01"}           | ${"second"}      | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:00:59"}           | ${"second"}      | ${59}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:00:00.001"}       | ${"millisecond"} | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:00:00.000001"}    | ${"microsecond"} | ${1}
    ${"2024-03-17T00:00:00"} | ${"2024-03-17T00:00:00.000000001"} | ${"nanosecond"}  | ${1}
  `(
  ...
  it.each`
    dateTime1                | dateTime2
    ${"2024-03-17T12:00:00"} | ${"2023-01-01T00:00:00"}
