...
describe("splitIntervalByUnitDateTime", () => {
  ...
  it.each`
    start                    | end                      | unit         | amount
    ${null}                  | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${undefined}             | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${123}                   | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${true}                  | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${[]}                    | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${{}}                    | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${null}                  | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${undefined}             | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${123}                   | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${true}                  | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${[]}                    | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${{}}                    | ${"hour"}    | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${null}      | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${undefined} | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${123}       | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${true}      | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${[]}        | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${{}}        | ${1}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${null}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${undefined}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${"1"}
    ${"2024-01-01T12:00:00"} | ${"2024-01-01T14:00:00"} | ${"hour"}    | ${true}
  `(
