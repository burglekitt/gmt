...
describe("intervalsOverlapTime", () => {
  ...
  it.each`
    aStart        | aEnd          | bStart        | bEnd
    ${null}       | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${undefined}  | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${123}        | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${true}       | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${[]}         | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${{}}         | ${"12:00:00"} | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${null}       | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${undefined}  | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${123}        | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${true}       | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${[]}         | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${{}}         | ${"12:00:00"} | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${null}       | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${undefined}  | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${123}        | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${true}       | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${[]}         | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${{}}         | ${"18:00:00"}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${null}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${undefined}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${123}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${true}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${[]}
    ${"12:00:00"} | ${"12:00:00"} | ${"12:00:00"} | ${{}}
  `(
