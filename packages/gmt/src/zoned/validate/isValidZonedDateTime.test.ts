...
describe("isValidZonedDateTime", () => {
  it.each`
    ...
    ${"2024-03-17T14:30:45.123Z[UTC]"}
    ${"1970-01-01T05:45:00+05:30[Asia/Kathmandu]"}
  `(
  ...
  it.each`
    ...
    ${"2024-01-01T00:00:00+05:45[Asia/Kathmandu]"}      | ${true}
    ...
    ${"2024-01-01T00:00:00+03:00[Europe/Moscow]"}       | ${true}
    ...
    ${"2024-01-01T00:00:00+11:00[Australia/Lord_Howe]"} | ${true}
    ...
    ${"2024-01-01T00:00:00+13:00[Pacific/Apia]"}        | ${true}
    ...
    ${"2024-01-01T00:00:00+13:45[Pacific/Chatham]"}     | ${true}
    ...
    ${"2024-01-01T00:00:00+03:00[Europe/Istanbul]"}     | ${true}
    ...
    ${"2024-01-01T00:00:00+00:00[Europe/Lisbon]"}       | ${true}
    ...
    ${"2024-01-01T00:00:00+00:00[Europe/Dublin]"}       | ${true}
    ...
    ${"1980-01-01T00:00:00+01:00[Europe/Berlin]"}       | ${true}
    ${"1980-07-01T00:00:00+02:00[Europe/Berlin]"}       | ${true}
  `(
