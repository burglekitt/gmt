...
describe("addZoned", () => {
  it.each`
    ...
    ${"2024-03-17T14:30:00+00:00[UTC]"} | ${1}   | ${"microsecond"} | ${"2024-03-17T14:30:00.000001+00:00[UTC]"}
    ${"2024-03-17T14:30:00+00:00[UTC]"} | ${1}   | ${"nanosecond"}  | ${"2024-03-17T14:30:00.000000001+00:00[UTC]"}
  `(
