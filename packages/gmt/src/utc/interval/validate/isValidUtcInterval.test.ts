...
describe("isValidUtcInterval", () => {
  it.each`
    start                     | end                       | expected
    ${"2024-01-01T00:00:00Z"} | ${"2024-12-31T23:59:59Z"} | ${true}
  ...
  it.each`
    start                     | end                       | expected
    ${"2024-12-31T23:59:59Z"} | ${"2024-01-01T00:00:00Z"} | ${false}
  ...
  it("returns false when Temporal.Instant.from throws", () => {
    ...
    expect(
      isValidUtcInterval("2024-01-01T00:00:00Z", "2024-12-31T23:59:59Z"),
    ).toBe(false);
  });
});
