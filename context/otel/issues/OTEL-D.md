# OTEL-D — Context / baggage propagation
...
### OTEL-D1 — Context / baggage propagation (`setTimezoneInBaggage` + `getTimezoneFromBaggage` + `propagateTimezone`)

**Title:**

```
OTEL-D1 Implement context/baggage propagation: setTimezoneInBaggage, getTimezoneFromBaggage, propagateTimezone
```

**Description:**

```
Part of the gmt-otel epic — see `context/otel/index.md`, Phase 4.
Depends on OTEL-C1 (span helpers) and OTEL-A1 (package skeleton).
...
### OTEL-D2 — Context / baggage propagation tests

**Title:**

```
OTEL-D2 Add comprehensive tests for context/baggage propagation
```
...
```
Part of the gmt-otel epic — see `context/otel/index.md`, Phase 4.
Depends on OTEL-D1 (context implementation).
